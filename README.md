...
[다운로드](#-다운로드) · [핵심 기능](#-핵심-기능) · [개발](#%EF%B8%8F-개발-환경) · [로드맵](#-로드맵) · [PRD](meeting-mode-PRD.md)
...
상세 기획은 [PRD](meeting-mode-PRD.md), 변경 이력은 [CHANGELOG](CHANGELOG.md), 발표용 자료는 [presentation.md](presentation.md) 참고.
